...
class _UpdateStockFormState extends State<UpdateStockForm> {
  ...
  Future<void> _updateQuantities() async {
    ...
    String urlQuantityIn =
        'http://192.168.1.102:8080/api/${widget.stockId}/updateQuantityIn?quantityIn=$quantityIn';
    String urlQuantityOut =
        'http://192.168.1.102:8080/api/${widget.stockId}/updateQuantityOut?quantityOut=$quantityOut';
