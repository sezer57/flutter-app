...
class _UpdateStockFormState extends State<UpdateStockForm> {
  ...
  Future<void> _updateQuantities() async {
    ...
    String urlQuantityIn =
        'http://${await loadIP()}:8080/api/${widget.stockId}/updateQuantityIn?quantityIn=$quantityIn';
    String urlQuantityOut =
        'http://${await loadIP()}:8080/api/${widget.stockId}/updateQuantityOut?quantityOut=$quantityOut';
